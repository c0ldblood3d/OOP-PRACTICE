from BicycleDecorator import BicycleDecorator
  
mybike1 = BicycleDecorator(max_speed=25, capacity=1, luggage_spaces=2)
mybike2 = BicycleDecorator(max_speed=35, capacity=2, luggage_spaces=4)
mybike3 = BicycleDecorator(max_speed=20, capacity=1, luggage_spaces=1)
