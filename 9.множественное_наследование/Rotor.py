class Drone:
    ...
    def __init__(self, flight_time, camera_resolution):
...
class Helicopter:
    ...
    def __init__(self, rotor_diameter, fuel_capacity, max_altitude):
...
class Gyrocopter:
    def __init__(self, engine_power, rotor_type, takeoff_distance, empty_weight):
...
class Rotorcraft(Drone, Helicopter, Gyrocopter):
    def __init__(self, flight_time, camera_resolution, rotor_diameter, fuel_capacity, max_altitude, engine_power, rotor_type, takeoff_distance, empty_weight):
        Drone.__init__(self, flight_time, camera_resolution)
        Helicopter.__init__(self, rotor_diameter, fuel_capacity, max_altitude)
        Gyrocopter.__init__(self, engine_power, rotor_type, takeoff_distance, empty_weight)
